...
export const AppScopeFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.AppScopeFindUniqueOrThrowArgs> = z.object({
  select: AppScopeSelectSchema.optional(),
  include: z.lazy(() => AppScopeIncludeSchema).optional(),
  where: AppScopeWhereUniqueInputSchema,
}).strict() ;

export default AppScopeFindUniqueOrThrowArgsSchema;
