...
export const UiTemplateUpsertArgsSchema: z.ZodType<Prisma.UiTemplateUpsertArgs> = z.object({
  ...
  create: z.union([ UiTemplateCreateInputSchema,UiTemplateUncheckedCreateInputSchema ]),
  update: z.union([ UiTemplateUpdateInputSchema,UiTemplateUncheckedUpdateInputSchema ]),
}).strict() ;

export default UiTemplateUpsertArgsSchema;
