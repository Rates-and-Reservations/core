...
export const RateAddOnFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.RateAddOnFindUniqueOrThrowArgs> = z.object({
  select: RateAddOnSelectSchema.optional(),
  include: z.lazy(() => RateAddOnIncludeSchema).optional(),
  where: RateAddOnWhereUniqueInputSchema,
}).strict() ;

export default RateAddOnFindUniqueOrThrowArgsSchema;
