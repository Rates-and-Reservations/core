...
export const RateAddOnCreateArgsSchema: z.ZodType<Prisma.RateAddOnCreateArgs> = z.object({
  select: RateAddOnSelectSchema.optional(),
  include: z.lazy(() => RateAddOnIncludeSchema).optional(),
  data: z.union([ RateAddOnCreateInputSchema,RateAddOnUncheckedCreateInputSchema ]),
}).strict() ;

export default RateAddOnCreateArgsSchema;
