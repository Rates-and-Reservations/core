...
import { AddOnCreateInputSchema } from '../inputTypeSchemas/AddOnCreateInputSchema'
import { AddOnUncheckedCreateInputSchema } from '../inputTypeSchemas/AddOnUncheckedCreateInputSchema'
import { AddOnUpdateInputSchema } from '../inputTypeSchemas/AddOnUpdateInputSchema'
import { AddOnUncheckedUpdateInputSchema } from '../inputTypeSchemas/AddOnUncheckedUpdateInputSchema'
...
export const AddOnUpsertArgsSchema: z.ZodType<Prisma.AddOnUpsertArgs> = z.object({
  select: AddOnSelectSchema.optional(),
  include: z.lazy(() => AddOnIncludeSchema).optional(),
  where: AddOnWhereUniqueInputSchema,
  create: z.union([ AddOnCreateInputSchema,AddOnUncheckedCreateInputSchema ]),
  update: z.union([ AddOnUpdateInputSchema,AddOnUncheckedUpdateInputSchema ]),
}).strict() ;

export default AddOnUpsertArgsSchema;
