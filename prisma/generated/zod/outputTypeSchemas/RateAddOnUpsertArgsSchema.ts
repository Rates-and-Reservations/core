...
import { RateAddOnCreateInputSchema } from '../inputTypeSchemas/RateAddOnCreateInputSchema'
import { RateAddOnUncheckedCreateInputSchema } from '../inputTypeSchemas/RateAddOnUncheckedCreateInputSchema'
...
export const RateAddOnUpsertArgsSchema: z.ZodType<Prisma.RateAddOnUpsertArgs> = z.object({
  select: RateAddOnSelectSchema.optional(),
  include: z.lazy(() => RateAddOnIncludeSchema).optional(),
  where: RateAddOnWhereUniqueInputSchema,
  create: z.union([ RateAddOnCreateInputSchema,RateAddOnUncheckedCreateInputSchema ]),
  update: z.union([ RateAddOnUpdateInputSchema,RateAddOnUncheckedUpdateInputSchema ]),
}).strict() ;

export default RateAddOnUpsertArgsSchema;
