...
import { PaymentActionsUpdateInputSchema } from '../inputTypeSchemas/PaymentActionsUpdateInputSchema'
import { PaymentActionsUncheckedUpdateInputSchema } from '../inputTypeSchemas/PaymentActionsUncheckedUpdateInputSchema'
...
export const PaymentActionsUpsertArgsSchema: z.ZodType<Prisma.PaymentActionsUpsertArgs> = z.object({
  select: PaymentActionsSelectSchema.optional(),
  include: z.lazy(() => PaymentActionsIncludeSchema).optional(),
  where: PaymentActionsWhereUniqueInputSchema,
  create: z.union([ PaymentActionsCreateInputSchema,PaymentActionsUncheckedCreateInputSchema ]),
  update: z.union([ PaymentActionsUpdateInputSchema,PaymentActionsUncheckedUpdateInputSchema ]),
}).strict() ;

export default PaymentActionsUpsertArgsSchema;
