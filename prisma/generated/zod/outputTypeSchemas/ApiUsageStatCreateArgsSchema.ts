...
export const ApiUsageStatCreateArgsSchema: z.ZodType<Prisma.ApiUsageStatCreateArgs> = z.object({
  select: ApiUsageStatSelectSchema.optional(),
  include: z.lazy(() => ApiUsageStatIncludeSchema).optional(),
  data: z.union([ ApiUsageStatCreateInputSchema,ApiUsageStatUncheckedCreateInputSchema ]),
}).strict() ;

export default ApiUsageStatCreateArgsSchema;
