...
export const AddOnUpdateArgsSchema: z.ZodType<Prisma.AddOnUpdateArgs> = z.object({
  select: AddOnSelectSchema.optional(),
  include: z.lazy(() => AddOnIncludeSchema).optional(),
  data: z.union([ AddOnUpdateInputSchema,AddOnUncheckedUpdateInputSchema ]),
  where: AddOnWhereUniqueInputSchema,
}).strict() ;

export default AddOnUpdateArgsSchema;
