...
export const RefundRequestCreateArgsSchema: z.ZodType<Prisma.RefundRequestCreateArgs> = z.object({
  select: RefundRequestSelectSchema.optional(),
  include: z.lazy(() => RefundRequestIncludeSchema).optional(),
  data: z.union([ RefundRequestCreateInputSchema,RefundRequestUncheckedCreateInputSchema ]),
}).strict() ;

export default RefundRequestCreateArgsSchema;
