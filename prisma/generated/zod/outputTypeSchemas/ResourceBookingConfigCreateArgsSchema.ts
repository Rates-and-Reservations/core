...
export const ResourceBookingConfigCreateArgsSchema: z.ZodType<Prisma.ResourceBookingConfigCreateArgs> = z.object({
  select: ResourceBookingConfigSelectSchema.optional(),
  include: z.lazy(() => ResourceBookingConfigIncludeSchema).optional(),
  data: z.union([ ResourceBookingConfigCreateInputSchema,ResourceBookingConfigUncheckedCreateInputSchema ]),
}).strict() ;

export default ResourceBookingConfigCreateArgsSchema;
