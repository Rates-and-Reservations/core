...
export const ResourceAssetUpdateArgsSchema: z.ZodType<Prisma.ResourceAssetUpdateArgs> = z.object({
  select: ResourceAssetSelectSchema.optional(),
  include: z.lazy(() => ResourceAssetIncludeSchema).optional(),
  data: z.union([ ResourceAssetUpdateInputSchema,ResourceAssetUncheckedUpdateInputSchema ]),
  where: ResourceAssetWhereUniqueInputSchema,
}).strict() ;

export default ResourceAssetUpdateArgsSchema;
