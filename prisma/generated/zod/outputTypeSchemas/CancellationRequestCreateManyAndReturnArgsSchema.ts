...
export const CancellationRequestCreateManyAndReturnArgsSchema: z.ZodType<Prisma.CancellationRequestCreateManyAndReturnArgs> = z.object({
  data: z.union([ CancellationRequestCreateManyInputSchema,CancellationRequestCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default CancellationRequestCreateManyAndReturnArgsSchema;
