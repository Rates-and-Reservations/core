...
export const BookingActivityLogUpdateArgsSchema: z.ZodType<Prisma.BookingActivityLogUpdateArgs> = z.object({
  select: BookingActivityLogSelectSchema.optional(),
  include: z.lazy(() => BookingActivityLogIncludeSchema).optional(),
  data: z.union([ BookingActivityLogUpdateInputSchema,BookingActivityLogUncheckedUpdateInputSchema ]),
  where: BookingActivityLogWhereUniqueInputSchema,
}).strict() ;

export default BookingActivityLogUpdateArgsSchema;
