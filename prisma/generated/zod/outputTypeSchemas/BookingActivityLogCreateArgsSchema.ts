...
export const BookingActivityLogCreateArgsSchema: z.ZodType<Prisma.BookingActivityLogCreateArgs> = z.object({
  select: BookingActivityLogSelectSchema.optional(),
  include: z.lazy(() => BookingActivityLogIncludeSchema).optional(),
  data: z.union([ BookingActivityLogCreateInputSchema,BookingActivityLogUncheckedCreateInputSchema ]),
}).strict() ;

export default BookingActivityLogCreateArgsSchema;
