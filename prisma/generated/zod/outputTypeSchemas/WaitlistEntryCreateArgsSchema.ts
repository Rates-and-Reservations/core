...
export const WaitlistEntryCreateArgsSchema: z.ZodType<Prisma.WaitlistEntryCreateArgs> = z.object({
  select: WaitlistEntrySelectSchema.optional(),
  include: z.lazy(() => WaitlistEntryIncludeSchema).optional(),
  data: z.union([ WaitlistEntryCreateInputSchema,WaitlistEntryUncheckedCreateInputSchema ]),
}).strict() ;

export default WaitlistEntryCreateArgsSchema;
