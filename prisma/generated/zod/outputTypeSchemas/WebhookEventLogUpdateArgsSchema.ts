...
export const WebhookEventLogUpdateArgsSchema: z.ZodType<Prisma.WebhookEventLogUpdateArgs> = z.object({
  select: WebhookEventLogSelectSchema.optional(),
  include: z.lazy(() => WebhookEventLogIncludeSchema).optional(),
  data: z.union([ WebhookEventLogUpdateInputSchema,WebhookEventLogUncheckedUpdateInputSchema ]),
  where: WebhookEventLogWhereUniqueInputSchema,
}).strict() ;

export default WebhookEventLogUpdateArgsSchema;
