...
export const BookingRequestFlowCreateArgsSchema: z.ZodType<Prisma.BookingRequestFlowCreateArgs> = z.object({
  select: BookingRequestFlowSelectSchema.optional(),
  include: z.lazy(() => BookingRequestFlowIncludeSchema).optional(),
  data: z.union([ BookingRequestFlowCreateInputSchema,BookingRequestFlowUncheckedCreateInputSchema ]),
}).strict() ;

export default BookingRequestFlowCreateArgsSchema;
