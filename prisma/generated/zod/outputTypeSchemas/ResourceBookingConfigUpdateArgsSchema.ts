...
export const ResourceBookingConfigUpdateArgsSchema: z.ZodType<Prisma.ResourceBookingConfigUpdateArgs> = z.object({
  select: ResourceBookingConfigSelectSchema.optional(),
  include: z.lazy(() => ResourceBookingConfigIncludeSchema).optional(),
  data: z.union([ ResourceBookingConfigUpdateInputSchema,ResourceBookingConfigUncheckedUpdateInputSchema ]),
  where: ResourceBookingConfigWhereUniqueInputSchema,
}).strict() ;

export default ResourceBookingConfigUpdateArgsSchema;
