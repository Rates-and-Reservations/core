...
export const PaymentActionsUpdateArgsSchema: z.ZodType<Prisma.PaymentActionsUpdateArgs> = z.object({
  select: PaymentActionsSelectSchema.optional(),
  include: z.lazy(() => PaymentActionsIncludeSchema).optional(),
  data: z.union([ PaymentActionsUpdateInputSchema,PaymentActionsUncheckedUpdateInputSchema ]),
  where: PaymentActionsWhereUniqueInputSchema,
}).strict() ;

export default PaymentActionsUpdateArgsSchema;
