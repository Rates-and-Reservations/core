...
export const WaitlistEntryUpdateArgsSchema: z.ZodType<Prisma.WaitlistEntryUpdateArgs> = z.object({
  select: WaitlistEntrySelectSchema.optional(),
  include: z.lazy(() => WaitlistEntryIncludeSchema).optional(),
  data: z.union([ WaitlistEntryUpdateInputSchema,WaitlistEntryUncheckedUpdateInputSchema ]),
  where: WaitlistEntryWhereUniqueInputSchema,
}).strict() ;

export default WaitlistEntryUpdateArgsSchema;
