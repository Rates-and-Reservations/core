...
export const InvoicePaymentCreateArgsSchema: z.ZodType<Prisma.InvoicePaymentCreateArgs> = z.object({
  select: InvoicePaymentSelectSchema.optional(),
  include: z.lazy(() => InvoicePaymentIncludeSchema).optional(),
  data: z.union([ InvoicePaymentCreateInputSchema,InvoicePaymentUncheckedCreateInputSchema ]),
}).strict() ;

export default InvoicePaymentCreateArgsSchema;
