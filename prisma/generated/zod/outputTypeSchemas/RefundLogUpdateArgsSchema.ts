...
export const RefundLogUpdateArgsSchema: z.ZodType<Prisma.RefundLogUpdateArgs> = z.object({
  select: RefundLogSelectSchema.optional(),
  include: z.lazy(() => RefundLogIncludeSchema).optional(),
  data: z.union([ RefundLogUpdateInputSchema,RefundLogUncheckedUpdateInputSchema ]),
  where: RefundLogWhereUniqueInputSchema,
}).strict() ;

export default RefundLogUpdateArgsSchema;
