...
export const BookingActionUpsertArgsSchema: z.ZodType<Prisma.BookingActionUpsertArgs> = z.object({
  ...
  create: z.union([ BookingActionCreateInputSchema,BookingActionUncheckedCreateInputSchema ]),
  update: z.union([ BookingActionUpdateInputSchema,BookingActionUncheckedUpdateInputSchema ]),
}).strict() ;

export default BookingActionUpsertArgsSchema;
