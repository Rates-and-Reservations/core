...
export const ResourceTemplateUpsertArgsSchema: z.ZodType<Prisma.ResourceTemplateUpsertArgs> = z.object({
  ...
  create: z.union([ ResourceTemplateCreateInputSchema,ResourceTemplateUncheckedCreateInputSchema ]),
  update: z.union([ ResourceTemplateUpdateInputSchema,ResourceTemplateUncheckedUpdateInputSchema ]),
}).strict() ;

export default ResourceTemplateUpsertArgsSchema;
