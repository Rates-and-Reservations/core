...
export const AppInstallUpdateArgsSchema: z.ZodType<Prisma.AppInstallUpdateArgs> = z.object({
  select: AppInstallSelectSchema.optional(),
  include: z.lazy(() => AppInstallIncludeSchema).optional(),
  data: z.union([ AppInstallUpdateInputSchema,AppInstallUncheckedUpdateInputSchema ]),
  where: AppInstallWhereUniqueInputSchema,
}).strict() ;

export default AppInstallUpdateArgsSchema;
