...
export const ResourceBookingConfigFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ResourceBookingConfigFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ ResourceBookingConfigScalarFieldEnumSchema,ResourceBookingConfigScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default ResourceBookingConfigFindFirstOrThrowArgsSchema;
