...
export const AppScopeUpsertArgsSchema: z.ZodType<Prisma.AppScopeUpsertArgs> = z.object({
  select: AppScopeSelectSchema.optional(),
  include: z.lazy(() => AppScopeIncludeSchema).optional(),
  where: AppScopeWhereUniqueInputSchema,
  create: z.union([ AppScopeCreateInputSchema,AppScopeUncheckedCreateInputSchema ]),
  update: z.union([ AppScopeUpdateInputSchema,AppScopeUncheckedUpdateInputSchema ]),
}).strict() ;

export default AppScopeUpsertArgsSchema;
