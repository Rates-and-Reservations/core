...
export const ApiUsageLogCreateArgsSchema: z.ZodType<Prisma.ApiUsageLogCreateArgs> = z.object({
  select: ApiUsageLogSelectSchema.optional(),
  include: z.lazy(() => ApiUsageLogIncludeSchema).optional(),
  data: z.union([ ApiUsageLogCreateInputSchema,ApiUsageLogUncheckedCreateInputSchema ]),
}).strict() ;

export default ApiUsageLogCreateArgsSchema;
