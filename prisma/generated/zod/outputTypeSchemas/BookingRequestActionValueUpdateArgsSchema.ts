...
export const BookingRequestActionValueUpdateArgsSchema: z.ZodType<Prisma.BookingRequestActionValueUpdateArgs> = z.object({
  select: BookingRequestActionValueSelectSchema.optional(),
  include: z.lazy(() => BookingRequestActionValueIncludeSchema).optional(),
  data: z.union([ BookingRequestActionValueUpdateInputSchema,BookingRequestActionValueUncheckedUpdateInputSchema ]),
  where: BookingRequestActionValueWhereUniqueInputSchema,
}).strict() ;

export default BookingRequestActionValueUpdateArgsSchema;
