...
export const BookingRateSnapshotUpsertArgsSchema: z.ZodType<Prisma.BookingRateSnapshotUpsertArgs> = z.object({
  ...
  create: z.union([ BookingRateSnapshotCreateInputSchema,BookingRateSnapshotUncheckedCreateInputSchema ]),
  update: z.union([ BookingRateSnapshotUpdateInputSchema,BookingRateSnapshotUncheckedUpdateInputSchema ]),
}).strict() ;

export default BookingRateSnapshotUpsertArgsSchema;
