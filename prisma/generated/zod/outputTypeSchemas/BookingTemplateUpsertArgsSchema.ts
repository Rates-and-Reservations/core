...
import { BookingTemplateUpdateInputSchema } from '../inputTypeSchemas/BookingTemplateUpdateInputSchema'
import { BookingTemplateUncheckedUpdateInputSchema } from '../inputTypeSchemas/BookingTemplateUncheckedUpdateInputSchema'
...
export const BookingTemplateUpsertArgsSchema: z.ZodType<Prisma.BookingTemplateUpsertArgs> = z.object({
  ...
  create: z.union([ BookingTemplateCreateInputSchema,BookingTemplateUncheckedCreateInputSchema ]),
  update: z.union([ BookingTemplateUpdateInputSchema,BookingTemplateUncheckedUpdateInputSchema ]),
}).strict() ;

export default BookingTemplateUpsertArgsSchema;
