...
export const BookingAddOnCreateArgsSchema: z.ZodType<Prisma.BookingAddOnCreateArgs> = z.object({
  select: BookingAddOnSelectSchema.optional(),
  include: z.lazy(() => BookingAddOnIncludeSchema).optional(),
  data: z.union([ BookingAddOnCreateInputSchema,BookingAddOnUncheckedCreateInputSchema ]),
}).strict() ;

export default BookingAddOnCreateArgsSchema;
