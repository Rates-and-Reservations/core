...
export const AddOnCreateArgsSchema: z.ZodType<Prisma.AddOnCreateArgs> = z.object({
  select: AddOnSelectSchema.optional(),
  include: z.lazy(() => AddOnIncludeSchema).optional(),
  data: z.union([ AddOnCreateInputSchema,AddOnUncheckedCreateInputSchema ]),
}).strict() ;

export default AddOnCreateArgsSchema;
