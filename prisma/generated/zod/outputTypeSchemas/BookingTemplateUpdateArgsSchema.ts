...
export const BookingTemplateUpdateArgsSchema: z.ZodType<Prisma.BookingTemplateUpdateArgs> = z.object({
  select: BookingTemplateSelectSchema.optional(),
  include: z.lazy(() => BookingTemplateIncludeSchema).optional(),
  data: z.union([ BookingTemplateUpdateInputSchema,BookingTemplateUncheckedUpdateInputSchema ]),
  where: BookingTemplateWhereUniqueInputSchema,
}).strict() ;

export default BookingTemplateUpdateArgsSchema;
