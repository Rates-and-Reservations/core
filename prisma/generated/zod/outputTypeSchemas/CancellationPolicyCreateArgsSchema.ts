...
export const CancellationPolicyCreateArgsSchema: z.ZodType<Prisma.CancellationPolicyCreateArgs> = z.object({
  select: CancellationPolicySelectSchema.optional(),
  include: z.lazy(() => CancellationPolicyIncludeSchema).optional(),
  data: z.union([ CancellationPolicyCreateInputSchema,CancellationPolicyUncheckedCreateInputSchema ]),
}).strict() ;

export default CancellationPolicyCreateArgsSchema;
