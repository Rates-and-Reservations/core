...
import { RefundRequestCreateInputSchema } from '../inputTypeSchemas/RefundRequestCreateInputSchema'
import { RefundRequestUncheckedCreateInputSchema } from '../inputTypeSchemas/RefundRequestUncheckedCreateInputSchema'
...
export const RefundRequestUpsertArgsSchema: z.ZodType<Prisma.RefundRequestUpsertArgs> = z.object({
  ...
  create: z.union([ RefundRequestCreateInputSchema,RefundRequestUncheckedCreateInputSchema ]),
  update: z.union([ RefundRequestUpdateInputSchema,RefundRequestUncheckedUpdateInputSchema ]),
}).strict() ;

export default RefundRequestUpsertArgsSchema;
