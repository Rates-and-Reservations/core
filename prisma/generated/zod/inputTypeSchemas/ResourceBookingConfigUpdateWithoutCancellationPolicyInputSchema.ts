...
import { ResourceUpdateOneRequiredWithoutResourceBookingConfigNestedInputSchema } from './ResourceUpdateOneRequiredWithoutResourceBookingConfigNestedInputSchema';

export const ResourceBookingConfigUpdateWithoutCancellationPolicyInputSchema: z.ZodType<Prisma.ResourceBookingConfigUpdateWithoutCancellationPolicyInput> = z.object({
  ...
  resource: z.lazy(() => ResourceUpdateOneRequiredWithoutResourceBookingConfigNestedInputSchema).optional()
}).strict();

export default ResourceBookingConfigUpdateWithoutCancellationPolicyInputSchema;
