...
import { BookingUpdateOneWithoutInvoiceNestedInputSchema } from './BookingUpdateOneWithoutInvoiceNestedInputSchema';
import { CustomerUpdateOneWithoutInvoiceNestedInputSchema } from './CustomerUpdateOneWithoutInvoiceNestedInputSchema';

export const InvoiceUpdateWithoutInvoicePaymentInputSchema: z.ZodType<Prisma.InvoiceUpdateWithoutInvoicePaymentInput> = z.object({
  ...
  booking: z.lazy(() => BookingUpdateOneWithoutInvoiceNestedInputSchema).optional(),
  customer: z.lazy(() => CustomerUpdateOneWithoutInvoiceNestedInputSchema).optional()
}).strict();

export default InvoiceUpdateWithoutInvoicePaymentInputSchema;
