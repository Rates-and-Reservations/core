...
import { MerchantUpdateOneRequiredWithoutBookingActivityLogNestedInputSchema } from './MerchantUpdateOneRequiredWithoutBookingActivityLogNestedInputSchema';
import { BookingUpdateOneRequiredWithoutBookingActivityLogNestedInputSchema } from './BookingUpdateOneRequiredWithoutBookingActivityLogNestedInputSchema';

export const BookingActivityLogUpdateInputSchema: z.ZodType<Prisma.BookingActivityLogUpdateInput> = z.object({
  ...
  merchant: z.lazy(() => MerchantUpdateOneRequiredWithoutBookingActivityLogNestedInputSchema).optional(),
  booking: z.lazy(() => BookingUpdateOneRequiredWithoutBookingActivityLogNestedInputSchema).optional()
}).strict();

export default BookingActivityLogUpdateInputSchema;
