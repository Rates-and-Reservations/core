...
import { CustomerCreateNestedManyWithoutMerchantInputSchema } from './CustomerCreateNestedManyWithoutMerchantInputSchema';
...
export const MerchantCreateWithoutBookingActivityLogInputSchema: z.ZodType<Prisma.MerchantCreateWithoutBookingActivityLogInput> = z.object({
  ...
  Customer: z.lazy(() => CustomerCreateNestedManyWithoutMerchantInputSchema).optional(),
...
export default MerchantCreateWithoutBookingActivityLogInputSchema;
