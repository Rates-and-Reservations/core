...
export const BookingRequestFlowUncheckedUpdateManyWithoutBookingRequestInputSchema: z.ZodType<Prisma.BookingRequestFlowUncheckedUpdateManyWithoutBookingRequestInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  merchantId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  uiTemplateId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export default BookingRequestFlowUncheckedUpdateManyWithoutBookingRequestInputSchema;
