...
import { BookingItemUncheckedCreateNestedManyWithoutBookingRateSnapshotInputSchema } from './BookingItemUncheckedCreateNestedManyWithoutBookingRateSnapshotInputSchema';

export const BookingRateSnapshotUncheckedCreateWithoutRateInputSchema: z.ZodType<Prisma.BookingRateSnapshotUncheckedCreateWithoutRateInput> = z.object({
  ...
  BookingItem: z.lazy(() => BookingItemUncheckedCreateNestedManyWithoutBookingRateSnapshotInputSchema).optional()
}).strict();

export default BookingRateSnapshotUncheckedCreateWithoutRateInputSchema;
