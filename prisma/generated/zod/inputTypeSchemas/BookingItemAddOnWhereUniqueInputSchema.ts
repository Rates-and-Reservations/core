...
export const BookingItemAddOnWhereUniqueInputSchema: z.ZodType<Prisma.BookingItemAddOnWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
...
export default BookingItemAddOnWhereUniqueInputSchema;
