...
export const InvoicePaymentWhereUniqueInputSchema: z.ZodType<Prisma.InvoicePaymentWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
...
export default InvoicePaymentWhereUniqueInputSchema;
