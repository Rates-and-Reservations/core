...
import { RateUpdateManyWithoutDiscountNestedInputSchema } from './RateUpdateManyWithoutDiscountNestedInputSchema';
...
export const DiscountUpdateInputSchema: z.ZodType<Prisma.DiscountUpdateInput> = z.object({
  ...
  appliesToRates: z.lazy(() => RateUpdateManyWithoutDiscountNestedInputSchema).optional()
}).strict();
