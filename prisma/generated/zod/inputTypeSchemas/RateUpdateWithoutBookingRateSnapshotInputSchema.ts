...
import { RateAddOnUpdateManyWithoutRateNestedInputSchema } from './RateAddOnUpdateManyWithoutRateNestedInputSchema';

export const RateUpdateWithoutBookingRateSnapshotInputSchema: z.ZodType<Prisma.RateUpdateWithoutBookingRateSnapshotInput> = z.object({
  ...
  RateAddOn: z.lazy(() => RateAddOnUpdateManyWithoutRateNestedInputSchema).optional()
}).strict();

export default RateUpdateWithoutBookingRateSnapshotInputSchema;
