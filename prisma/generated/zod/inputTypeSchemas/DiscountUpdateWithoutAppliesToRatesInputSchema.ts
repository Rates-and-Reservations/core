...
import { MerchantUpdateOneRequiredWithoutDiscountNestedInputSchema } from './MerchantUpdateOneRequiredWithoutDiscountNestedInputSchema';

export const DiscountUpdateWithoutAppliesToRatesInputSchema: z.ZodType<Prisma.DiscountUpdateWithoutAppliesToRatesInput> = z.object({
  ...
  merchant: z.lazy(() => MerchantUpdateOneRequiredWithoutDiscountNestedInputSchema).optional()
}).strict();

export default DiscountUpdateWithoutAppliesToRatesInputSchema;
