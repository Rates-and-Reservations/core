...
import { DiscountUncheckedUpdateManyWithoutAppliesToRatesNestedInputSchema } from './DiscountUncheckedUpdateManyWithoutAppliesToRatesNestedInputSchema';
import { RateAddOnUncheckedUpdateManyWithoutRateNestedInputSchema } from './RateAddOnUncheckedUpdateManyWithoutRateNestedInputSchema';
import { BookingRateSnapshotUncheckedUpdateManyWithoutRateNestedInputSchema } from './BookingRateSnapshotUncheckedUpdateManyWithoutRateNestedInputSchema';

export const RateUncheckedUpdateWithoutResourceInputSchema: z.ZodType<Prisma.RateUncheckedUpdateWithoutResourceInput> = z.object({
  ...
  Discount: z.lazy(() => DiscountUncheckedUpdateManyWithoutAppliesToRatesNestedInputSchema).optional(),
  RateAddOn: z.lazy(() => RateAddOnUncheckedUpdateManyWithoutRateNestedInputSchema).optional(),
  BookingRateSnapshot: z.lazy(() => BookingRateSnapshotUncheckedUpdateManyWithoutRateNestedInputSchema).optional()
}).strict();

export default RateUncheckedUpdateWithoutResourceInputSchema;
