...
export const PaymentActionsWhereUniqueInputSchema: z.ZodType<Prisma.PaymentActionsWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
...
export default PaymentActionsWhereUniqueInputSchema;
