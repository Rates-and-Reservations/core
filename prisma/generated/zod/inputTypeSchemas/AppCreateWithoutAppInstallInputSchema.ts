...
import { MerchantCreateNestedOneWithoutAppInputSchema } from './MerchantCreateNestedOneWithoutAppInputSchema';
import { OAuthTokenCreateNestedManyWithoutAppInputSchema } from './OAuthTokenCreateNestedManyWithoutAppInputSchema';

export const AppCreateWithoutAppInstallInputSchema: z.ZodType<Prisma.AppCreateWithoutAppInstallInput> = z.object({
  ...
  merchant: z.lazy(() => MerchantCreateNestedOneWithoutAppInputSchema),
  OAuthToken: z.lazy(() => OAuthTokenCreateNestedManyWithoutAppInputSchema).optional()
}).strict();

export default AppCreateWithoutAppInstallInputSchema;
