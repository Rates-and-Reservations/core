...
import { BookingRequestUpdateOneRequiredWithoutBookingRequestFlowNestedInputSchema } from './BookingRequestUpdateOneRequiredWithoutBookingRequestFlowNestedInputSchema';
...
export const BookingRequestFlowUpdateWithoutUiTemplateInputSchema: z.ZodType<Prisma.BookingRequestFlowUpdateWithoutUiTemplateInput> = z.object({
  ...
  bookingRequest: z.lazy(() => BookingRequestUpdateOneRequiredWithoutBookingRequestFlowNestedInputSchema).optional(),
  merchant: z.lazy(() => MerchantUpdateOneRequiredWithoutBookingRequestFlowNestedInputSchema).optional()
}).strict();

export default BookingRequestFlowUpdateWithoutUiTemplateInputSchema;
