...
import { ResourceBookingConfigUpdateManyWithoutCancellationPolicyNestedInputSchema } from './ResourceBookingConfigUpdateManyWithoutCancellationPolicyNestedInputSchema';

export const CancellationPolicyUpdateWithoutMerchantInputSchema: z.ZodType<Prisma.CancellationPolicyUpdateWithoutMerchantInput> = z.object({
  ...
  ResourceBookingConfig: z.lazy(() => ResourceBookingConfigUpdateManyWithoutCancellationPolicyNestedInputSchema).optional()
}).strict();

export default CancellationPolicyUpdateWithoutMerchantInputSchema;
