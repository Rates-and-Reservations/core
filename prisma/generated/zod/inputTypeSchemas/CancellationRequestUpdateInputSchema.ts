...
import { BookingUpdateOneRequiredWithoutCancellationRequestNestedInputSchema } from './BookingUpdateOneRequiredWithoutCancellationRequestNestedInputSchema';
import { BookingItemUpdateOneWithoutCancellationRequestNestedInputSchema } from './BookingItemUpdateOneWithoutCancellationRequestNestedInputSchema';

export const CancellationRequestUpdateInputSchema: z.ZodType<Prisma.CancellationRequestUpdateInput> = z.object({
  ...
  booking: z.lazy(() => BookingUpdateOneRequiredWithoutCancellationRequestNestedInputSchema).optional(),
  bookingItem: z.lazy(() => BookingItemUpdateOneWithoutCancellationRequestNestedInputSchema).optional()
}).strict();

export default CancellationRequestUpdateInputSchema;
