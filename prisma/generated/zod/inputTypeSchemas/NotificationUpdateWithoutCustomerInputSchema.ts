...
import { BookingUpdateOneWithoutNotificationNestedInputSchema } from './BookingUpdateOneWithoutNotificationNestedInputSchema';
...
export const NotificationUpdateWithoutCustomerInputSchema: z.ZodType<Prisma.NotificationUpdateWithoutCustomerInput> = z.object({
  ...
  booking: z.lazy(() => BookingUpdateOneWithoutNotificationNestedInputSchema).optional(),
  template: z.lazy(() => NotificationTemplateUpdateOneWithoutNotificationNestedInputSchema).optional()
}).strict();

export default NotificationUpdateWithoutCustomerInputSchema;
