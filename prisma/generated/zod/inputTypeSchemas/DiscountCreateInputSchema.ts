...
import { RateCreateNestedManyWithoutDiscountInputSchema } from './RateCreateNestedManyWithoutDiscountInputSchema';
...
export const DiscountCreateInputSchema: z.ZodType<Prisma.DiscountCreateInput> = z.object({
  ...
  appliesToRates: z.lazy(() => RateCreateNestedManyWithoutDiscountInputSchema).optional()
}).strict();
