...
import { WebhookEndpointUpdateOneRequiredWithoutWebhookEventNestedInputSchema } from './WebhookEndpointUpdateOneRequiredWithoutWebhookEventNestedInputSchema';

export const WebhookEventUpdateWithoutWebhookEventLogInputSchema: z.ZodType<Prisma.WebhookEventUpdateWithoutWebhookEventLogInput> = z.object({
  ...
  endpoint: z.lazy(() => WebhookEndpointUpdateOneRequiredWithoutWebhookEventNestedInputSchema).optional()
}).strict();

export default WebhookEventUpdateWithoutWebhookEventLogInputSchema;
