...
import { NotificationUpdateManyWithoutTemplateNestedInputSchema } from './NotificationUpdateManyWithoutTemplateNestedInputSchema';

export const NotificationTemplateUpdateInputSchema: z.ZodType<Prisma.NotificationTemplateUpdateInput> = z.object({
  ...
  Notification: z.lazy(() => NotificationUpdateManyWithoutTemplateNestedInputSchema).optional()
}).strict();

export default NotificationTemplateUpdateInputSchema;
