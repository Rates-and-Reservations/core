...
export const AppInstallScopeUpdateWithoutAppInstallInputSchema: z.ZodType<Prisma.AppInstallScopeUpdateWithoutAppInstallInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  scope: z.lazy(() => AppScopeUpdateOneRequiredWithoutAppInstallScopeNestedInputSchema).optional()
}).strict();

export default AppInstallScopeUpdateWithoutAppInstallInputSchema;
