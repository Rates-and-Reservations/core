...
import { RefundRequestUpdateManyWithoutPaymentTransactionNestedInputSchema } from './RefundRequestUpdateManyWithoutPaymentTransactionNestedInputSchema';
...
export const PaymentActionsUpdateWithoutInvoicePaymentInputSchema: z.ZodType<Prisma.PaymentActionsUpdateWithoutInvoicePaymentInput> = z.object({
  ...
  RefundRequest: z.lazy(() => RefundRequestUpdateManyWithoutPaymentTransactionNestedInputSchema).optional(),
  RefundLog: z.lazy(() => RefundLogUpdateManyWithoutPaymentTransactionNestedInputSchema).optional()
}).strict();

export default PaymentActionsUpdateWithoutInvoicePaymentInputSchema;
