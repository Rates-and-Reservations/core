...
import { RateUpdateOneRequiredWithoutBookingRateSnapshotNestedInputSchema } from './RateUpdateOneRequiredWithoutBookingRateSnapshotNestedInputSchema';
import { BookingItemUpdateManyWithoutBookingRateSnapshotNestedInputSchema } from './BookingItemUpdateManyWithoutBookingRateSnapshotNestedInputSchema';

export const BookingRateSnapshotUpdateInputSchema: z.ZodType<Prisma.BookingRateSnapshotUpdateInput> = z.object({
  ...
  rate: z.lazy(() => RateUpdateOneRequiredWithoutBookingRateSnapshotNestedInputSchema).optional(),
  BookingItem: z.lazy(() => BookingItemUpdateManyWithoutBookingRateSnapshotNestedInputSchema).optional()
}).strict();

export default BookingRateSnapshotUpdateInputSchema;
