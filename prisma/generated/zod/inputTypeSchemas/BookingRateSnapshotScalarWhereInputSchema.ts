...
export const BookingRateSnapshotScalarWhereInputSchema: z.ZodType<Prisma.BookingRateSnapshotScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => BookingRateSnapshotScalarWhereInputSchema),z.lazy(() => BookingRateSnapshotScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => BookingRateSnapshotScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BookingRateSnapshotScalarWhereInputSchema),z.lazy(() => BookingRateSnapshotScalarWhereInputSchema).array() ]).optional(),
...
export default BookingRateSnapshotScalarWhereInputSchema;
