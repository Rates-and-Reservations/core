...
export const BookingRateSnapshotWhereUniqueInputSchema: z.ZodType<Prisma.BookingRateSnapshotWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => BookingRateSnapshotWhereInputSchema),z.lazy(() => BookingRateSnapshotWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => BookingRateSnapshotWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BookingRateSnapshotWhereInputSchema),z.lazy(() => BookingRateSnapshotWhereInputSchema).array() ]).optional(),
...
export default BookingRateSnapshotWhereUniqueInputSchema;
