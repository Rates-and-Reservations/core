...
import { MerchantUpdateOneRequiredWithoutApiUsageLogNestedInputSchema } from './MerchantUpdateOneRequiredWithoutApiUsageLogNestedInputSchema';
import { ApiKeyUpdateOneRequiredWithoutApiUsageLogNestedInputSchema } from './ApiKeyUpdateOneRequiredWithoutApiUsageLogNestedInputSchema';

export const ApiUsageLogUpdateInputSchema: z.ZodType<Prisma.ApiUsageLogUpdateInput> = z.object({
  ...
  merchant: z.lazy(() => MerchantUpdateOneRequiredWithoutApiUsageLogNestedInputSchema).optional(),
  apiKey: z.lazy(() => ApiKeyUpdateOneRequiredWithoutApiUsageLogNestedInputSchema).optional()
}).strict();

export default ApiUsageLogUpdateInputSchema;
