...
export const WebhookEventWhereUniqueInputSchema: z.ZodType<Prisma.WebhookEventWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  ...
  responseCode: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
...
export default WebhookEventWhereUniqueInputSchema;
